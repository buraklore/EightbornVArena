...
window.addEventListener('load', function() {
  ...
  function _buildHome() {
    ...
    ph.innerHTML =
    '<div style="max-width:1400px;margin:auto;padding:80px 32px 64px;display:flex;align-items:center;gap:48px" id="sec-home">' +
      '<div style="flex:1;min-width:300px">' +
        ...
        '</div>' +
      '</div>' +
      '<div id="hero-img-container" style="flex:1.6;min-width:0;width:55%;aspect-ratio:16/9;border-radius:18px;overflow:hidden;border:1px solid #ffffff08;position:relative;background:var(--bg2)">' +
