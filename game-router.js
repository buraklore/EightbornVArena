...
window.addEventListener('load', function() {
  ...
  function _buildHome() {
    ...
    ph.innerHTML =
    '<div style="max-width:1400px;margin:auto;padding:0 32px;display:flex;align-items:center;gap:64px;min-height:calc(100vh - 68px)" id="sec-home">' +
      '<div style="flex:1;min-width:280px">' +
        ...
        '</div>' +
      '</div>' +
      '<div id="hero-img-container" style="flex:1.5;min-width:480px;aspect-ratio:16/9;border-radius:18px;overflow:hidden;border:1px solid #ffffff08;position:relative;background:var(--bg2)">' +
    ...
    '<div style="max-width:1400px;margin:0 auto;padding:32px 32px 0"><div style="display:grid;grid-template-columns:repeat(4,1fr);gap:14px" id="stats-bar">' +
