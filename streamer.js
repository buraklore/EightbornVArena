...
function streamStart() {
  ...
  ag.innerHTML = 
    ...
    '<div style="width:92px;height:92px;border-radius:20px;background:rgba(232,67,62,.12);display:flex;align-items:center;justify-content:center;font-size:44px;margin:0 auto 16px;border:1px solid #ffffff0a">\ud83c\udfa5</div>' +
