...
function streamStart() {
  ...
  ag.innerHTML = 
    ...
    '<div class="gi" style="background:linear-gradient(135deg,#ff0000,#cc0000);width:72px;height:72px;font-size:64px">\ud83c\udfa5</div>' +
    ...
    '<div class="game-card" style="border:1px solid #f59e0b40;border-radius:20px;background:var(--bg2);padding:36px 24px;text-align:center;cursor:pointer;transition:all .3s;position:relative" onclick="streamSetup(\'QUOTE\')" onmouseover="this.style.transform=\'translateY(-6px)\';this.style.boxShadow=\'0 12px 40px #f59e0b25\'" onmouseout="this.style.transform=\'\';this.style.boxShadow=\'\'"><div style="position:absolute;top:10px;right:10px;background:linear-gradient(135deg,#ff0000,#ff4444);color:#fff;font-size:10px;font-weight:800;padding:3px 10px;border-radius:20px">\u0130NTERAKT\u0130F</div><div style="width:100px;height:100px;border-radius:20px;background:linear-gradient(135deg,#f59e0b,#eab308);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:64px">\ud83d\udcac</div><h3 class="fd" style="font-size:24px;font-weight:700;margin-bottom:10px">Replik Bil</h3><p style="font-size:15px;color:var(--t3)">Repli\u011fi kime ait?</p></div>' +
    '<div class="game-card" style="border:1px solid #2dd4bf40;border-radius:20px;background:var(--bg2);padding:36px 24px;text-align:center;cursor:pointer;transition:all .3s;position:relative" onclick="streamSetup(\'FACE\')" onmouseover="this.style.transform=\'translateY(-6px)\';this.style.boxShadow=\'0 12px 40px #2dd4bf25\'" onmouseout="this.style.transform=\'\';this.style.boxShadow=\'\'"><div style="position:absolute;top:10px;right:10px;background:linear-gradient(135deg,#ff0000,#ff4444);color:#fff;font-size:10px;font-weight:800;padding:3px 10px;border-radius:20px">\u0130NTERAKT\u0130F</div><div style="width:100px;height:100px;border-radius:20px;background:linear-gradient(135deg,#2dd4bf,#2dd4bf);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:64px">\ud83e\udd14</div><h3 class="fd" style="font-size:24px;font-weight:700;margin-bottom:10px">Y\u00fczden Bil</h3><p style="font-size:15px;color:var(--t3)">Karakteri tan\u0131!</p></div>' +
    '<div class="game-card" style="border:1px solid #e8433e40;border-radius:20px;background:var(--bg2);padding:36px 24px;text-align:center;cursor:pointer;transition:all .3s;position:relative" onclick="streamSetup(\'MEMORY\')" onmouseover="this.style.transform=\'translateY(-6px)\';this.style.boxShadow=\'0 12px 40px #e8433e25\'" onmouseout="this.style.transform=\'\';this.style.boxShadow=\'\'"><div style="position:absolute;top:10px;right:10px;background:linear-gradient(135deg,#ff0000,#ff4444);color:#fff;font-size:10px;font-weight:800;padding:3px 10px;border-radius:20px">\u0130NTERAKT\u0130F</div><div style="width:100px;height:100px;border-radius:20px;background:linear-gradient(135deg,#e8433e,#3b82f6);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:64px">\ud83e\udde0</div><h3 class="fd" style="font-size:24px;font-weight:700;margin-bottom:10px">Eightborn Moruq</h3><p style="font-size:15px;color:var(--t3)">EightbornV hakk\u0131nda ne kadar bilgilisin?</p></div>' +
    '<div class="game-card" style="border:1px solid #e8433e40;border-radius:20px;background:var(--bg2);padding:36px 24px;text-align:center;cursor:pointer;transition:all .3s;position:relative" onclick="streamSetup(\'STORY\')" onmouseover="this.style.transform=\'translateY(-6px)\';this.style.boxShadow=\'0 12px 40px #e8433e25\'" onmouseout="this.style.transform=\'\';this.style.boxShadow=\'\'"><div style="position:absolute;top:10px;right:10px;background:linear-gradient(135deg,#ff0000,#ff4444);color:#fff;font-size:10px;font-weight:800;padding:3px 10px;border-radius:20px">\u0130NTERAKT\u0130F</div><div style="width:100px;height:100px;border-radius:20px;background:linear-gradient(135deg,#e8433e,#e8433e);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:64px">\ud83c\udfac</div><h3 class="fd" style="font-size:24px;font-weight:700;margin-bottom:10px">Chat Kaderini Belirler</h3><p style="font-size:15px;color:var(--t3)">Hikayeni chat belirler!</p></div>' +
    '<div class="game-card" style="border:1px solid #e8433e40;border-radius:20px;background:var(--bg2);padding:36px 24px;text-align:center;cursor:pointer;transition:all .3s;position:relative" onclick="streamSetup(\'CDIE\')" onmouseover="this.style.transform=\'translateY(-6px)\';this.style.boxShadow=\'0 12px 40px #e8433e25\'" onmouseout="this.style.transform=\'\';this.style.boxShadow=\'\'"><div style="position:absolute;top:10px;right:10px;background:linear-gradient(135deg,#ff0000,#ff4444);color:#fff;font-size:10px;font-weight:800;padding:3px 10px;border-radius:20px">\u0130NTERAKT\u0130F</div><div style="width:100px;height:100px;border-radius:20px;background:linear-gradient(135deg,#e8433e,#e8433e);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:64px">\ud83d\udc80</div><h3 class="fd" style="font-size:24px;font-weight:700;margin-bottom:10px">Kim Hayatta Kalacak</h3><p style="font-size:15px;color:var(--t3)">Chat CK\'y\u0131 belirler!</p></div>' +
    '<div class="game-card" style="border:1px solid #3b82f640;border-radius:20px;background:var(--bg2);padding:36px 24px;text-align:center;cursor:pointer;transition:all .3s;position:relative" onclick="streamSetup(\'CTEAM\')" onmouseover="this.style.transform=\'translateY(-6px)\';this.style.boxShadow=\'0 12px 40px #3b82f625\'" onmouseout="this.style.transform=\'\';this.style.boxShadow=\'\'"><div style="position:absolute;top:10px;right:10px;background:linear-gradient(135deg,#ff0000,#ff4444);color:#fff;font-size:10px;font-weight:800;padding:3px 10px;border-radius:20px">\u0130NTERAKT\u0130F</div><div style="width:100px;height:100px;border-radius:20px;background:linear-gradient(135deg,#3b82f6,#06b6d4);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:64px">\ud83d\udc65</div><h3 class="fd" style="font-size:24px;font-weight:700;margin-bottom:10px">Ekibini Kur</h3><p style="font-size:15px;color:var(--t3)">Ekibi chat belirler!</p></div>' +
    '<div class="game-card" style="border:1px solid #f4384840;border-radius:20px;background:var(--bg2);padding:36px 24px;text-align:center;cursor:pointer;transition:all .3s;position:relative" onclick="streamSetup(\'CFATE\')" onmouseover="this.style.transform=\'translateY(-6px)\';this.style.boxShadow=\'0 12px 40px #f4384825\'" onmouseout="this.style.transform=\'\';this.style.boxShadow=\'\'"><div style="position:absolute;top:10px;right:10px;background:linear-gradient(135deg,#ff0000,#ff4444);color:#fff;font-size:10px;font-weight:800;padding:3px 10px;border-radius:20px">\u0130NTERAKT\u0130F</div><div style="width:100px;height:100px;border-radius:20px;background:linear-gradient(135deg,#e8433e,#e8433e);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:64px">\ud83c\udfad</div><h3 class="fd" style="font-size:24px;font-weight:700;margin-bottom:10px">Kaderini Se\u00e7</h3><p style="font-size:15px;color:var(--t3)">Kaderi chat belirler!</p></div>' +
    '<div class="game-card" style="border:1px solid #ffffff20;border-radius:20px;background:var(--bg2);padding:48px 40px;text-align:center;position:relative;opacity:.6"><div style="position:absolute;top:10px;right:10px;background:linear-gradient(135deg,#666,#999);color:#fff;font-size:10px;font-weight:800;padding:3px 10px;border-radius:20px">YAKINDA</div><div style="width:100px;height:100px;border-radius:20px;background:linear-gradient(135deg,#666,#444);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:64px">\ud83c\udfae</div><h3 class="fd" style="font-size:24px;font-weight:700;margin-bottom:10px">Yay\u0131nc\u0131 Vs Chat</h3><p style="font-size:15px;color:var(--t3)">\u00c7ok yak\u0131nda!</p></div>' +
    '</div></div>';
}
...
function streamSetup(mode) {
  ...
  ag.innerHTML = 
    '<div style="display:flex;align-items:center;justify-content:center;gap:12px;padding:10px 0">' +
    '<button class="btn bg bsm" onclick="streamStart()">← Geri</button>' +
...
function streamerApply() {
  apiRequestStreamer().then(function(r) {
    ...
    var ag = document.getElementById('ag');
    ag.innerHTML = '<div style="flex:1;display:flex;align-items:center;justify-content:center"><div class="cg" style="text-align:center;padding:60px 40px;max-width:800px"><div style="font-size:80px;margin-bottom:16px">\u2705</div><h3 class="fd" style="font-size:28px;font-weight:700;margin-bottom:12px">Ba\u015fvuru G\u00f6nderildi</h3><p style="font-size:16px;color:var(--t2)">Admin onaylad\u0131\u011f\u0131nda Streamer Game\u2019i a\u00e7abileceksin.</p><button class="btn bg" style="margin-top:20px;font-size:14px;padding:10px 20px" onclick="bk()">\u2190 Geri</button></div></div>';
  });
}
